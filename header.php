...
<title><?php
	...
	if ( $paged >= 2 || $page >= 2 )
		echo ' | ' . sprintf( __( 'Page %s', 'portforwardpodcast' ), max( $paged, $page ) );
...
<script src="<?php echo get_template_directory_uri(); ?>/js/jquery.tagcanvas.min.js" type="text/javascript"></script>
</head>
