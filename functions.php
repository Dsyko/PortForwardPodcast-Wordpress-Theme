...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		// Latest Tweet
		array(
			'name'     				=> 'Latest Tweet Plugin', // The plugin name
			'slug'     				=> 'latesttweet', // The plugin slug (typically the folder name)
			'source'   				=> get_stylesheet_directory() . '/plugins/latesttweet.zip', // The plugin source
		...
		array(
			'name'     				=> 'Donors Plugin', // The plugin name
			'slug'     				=> 'donors', // The plugin slug (typically the folder name)
			'source'   				=> get_stylesheet_directory() . '/plugins/donors.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
	...
	$theme_text_domain = 'portforwardpodcast';
