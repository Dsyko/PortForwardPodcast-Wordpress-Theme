	...
	<footer class="entry-meta">
		<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			<?php
				...
				$categories_list = get_the_category_list( __( ', ', 'portforwardpodcast' ) );
				if ( $categories_list && portforwardpodcast_categorized_blog() ) :
			?>
			<span class="cat-links">
				<?php printf( __( 'Posted in %1$s', 'portforwardpodcast' ), $categories_list ); ?>
			</span>
			...
			<span class="tag-links">
				<?php printf( __( 'Tagged %1$s', 'portforwardpodcast' ), $tags_list ); ?>
			</span>
